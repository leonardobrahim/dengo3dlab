    ...
    <div className={cn('space-y-6 text-left', className)}>
      ...
      <div className="flex items-center justify-between pb-3 border-b border-pink-200/80 dark:border-pink-900/40">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-sm text-foreground">Filtros de Busca</h3>
          {activeFiltersCount > 0 && (
            <Badge variant="babyPink" className="text-[10px] px-2 py-0.5 font-bold">
              {activeFiltersCount}
            </Badge>
          )}
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 pt-1">
              <div className="relative flex-1">
                <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground font-bold">R$</span>
                <input
                  type="number"
                  placeholder="Mín"
            ...
            {MATERIAL_OPTIONS.map((mat) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span className={cn(isChecked && 'text-foreground font-semibold')}>{mat.label}</span>
                </label>
              );
            })}
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>{rating === 5 ? '5 estrelas' : `${rating} ou mais`}</span>
                  </div>
