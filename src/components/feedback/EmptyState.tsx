...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center p-8 sm:p-14 text-center rounded-3xl border border-pink-200/60 dark:border-pink-900/40 bg-gradient-to-b from-card/80 to-pink-50/30 dark:to-card/50 space-y-4 my-6 shadow-xs',
        className
      )}
    >
      ...
      {(actionLabel || secondaryActionLabel) && (
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          {actionLabel && onAction && (
            <Button variant="dengo" size="sm" onClick={onAction} className="gap-1.5 font-bold">
