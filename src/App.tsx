        ...
        return (
          <StoreLayout>
            <div className="space-y-6 text-left">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl border border-pink-200/80 dark:border-pink-900/50 bg-linear-to-r from-pink-50 via-white to-sky-50 dark:from-pink-950/40 dark:via-card dark:to-sky-950/30">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <Badge variant="candyGradient">ETAPA 1 & ETAPA 2</Badge>
                    <Badge variant="babyPink">
                      Painel de Componentes & Arquitetura
                    </Badge>
                  </div>
              ...
              <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none">
                {[
                  {
                    id: "design-system",
                    label: "1. Design System & UI Pastel",
                    icon: <Layers className="h-3.5 w-3.5" />,
                  },
                  {
                    id: "business-components",
                    label: "2. Componentes de Negócio",
                    icon: <Sparkles className="h-3.5 w-3.5" />,
                  },
                  {
                    id: "forms-validation",
                    label: "3. Validações Zod",
                    icon: <ShieldCheck className="h-3.5 w-3.5" />,
                  },
                  {
                    id: "state-services",
                    label: "4. Zustand & Mock REST",
