      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-20 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            {user ? (
              <div 
                className="hidden md:flex items-center gap-2 text-xs font-semibold text-slate-700 bg-slate-100 px-3 py-1.5 rounded-full border border-slate-200 cursor-pointer hover:bg-slate-200 transition-colors"
            ...
            {currentView === 'checkout' || currentView === 'order_success' ? (
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        ...
        {currentView === 'checkout' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 xl:col-span-7 space-y-6">
              ...
              <CheckoutForm onSuccess={() => setCurrentView('order_success')} />
            </div>
        ...
        {currentView === 'order_success' && (
          <OrderSuccess 
            ...
            onTrackOrder={() => setCurrentView('customer_portal')}
          />
        )}
