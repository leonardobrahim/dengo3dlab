  ...
  return (
    <footer className="w-full border-t border-pink-200/60 dark:border-pink-900/40 bg-card text-foreground transition-colors mt-auto">
      ...
      <div className="border-b border-pink-100 dark:border-pink-950/60 bg-gradient-to-r from-pink-50/70 via-background to-sky-50/70 dark:from-pink-950/20 dark:via-card dark:to-sky-950/20 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center sm:text-left">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-foreground">Envio Seguro & Rastreável</h4>
              <p className="text-[11px] text-muted-foreground">Embalagem protetora anti-impacto</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-foreground">Filamentos Premium</h4>
              <p className="text-[11px] text-muted-foreground">PLA Silk atóxico & alta precisão</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-foreground">Garantia Dengo Lab</h4>
              <p className="text-[11px] text-muted-foreground">7 dias para trocas e devoluções</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-foreground">Pagamento Protegido</h4>
              <p className="text-[11px] text-muted-foreground">Pix instantâneo ou até 12x no cartão</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed max-w-sm">
              O estúdio maker mais fofo do Brasil! Criamos peças colecionáveis articuladas, cortadores culinários em PLA atóxico e filamentos Candy Color com carinho e acabamento premium.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-muted-foreground">
              <li>
                <button
                  onClick={() => navigate('/categorias/colecionaveis-articulados')}
        ...
        {/* Newsletter Section */}
        <div className="rounded-3xl border border-pink-200/80 dark:border-pink-900/50 bg-gradient-to-r from-pink-50/80 via-white to-sky-50/80 dark:from-pink-950/30 dark:via-card dark:to-sky-950/30 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center md:text-left">
            ...
            <p className="text-xs text-muted-foreground">
              Cadastre seu e-mail e receba 15% OFF de boas-vindas, lançamentos de arquivos 3D e novidades Candy Color!
            </p>
          </div>
          ...
          >
            ...
            />
            <Button type="submit" variant="dengo" size="md" className="w-full sm:w-auto font-bold gap-1.5 shrink-0">
        ...
        <div className="pt-8 mt-8 border-t border-border/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left text-[11px] text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span className="flex items-center gap-1">
              Feito com <Heart className="h-3 w-3 text-pink-500 fill-current inline" /> para apaixonados por 3D
            </span>
          </div>
