...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <AccountLayout
      currentPageTitle="Meu Perfil"
      currentPageBreadcrumb="Meu Perfil"
    >
      <div className="space-y-6 text-left">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-600">
            Mantenha suas informações sempre atualizadas para notas fiscais e
            entregas
          </p>
        </div>
        ...
        <form
          ...
          className="p-6 sm:p-8 rounded-3xl border border-pink-100 bg-white space-y-6 shadow-xs"
        >
          {/* Avatar Edit */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-slate-500">
                Para alterar seu e-mail, contate o suporte.
              </p>
            </div>
