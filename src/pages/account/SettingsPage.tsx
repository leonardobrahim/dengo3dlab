...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <AccountLayout
      currentPageTitle="Configurações da Conta"
      currentPageBreadcrumb="Configurações"
    >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <p className="text-xs font-bold text-slate-900">
                  Avisos de Fatiamento e Envio por E-mail
                </p>
                <p className="text-[11px] text-slate-500">
                  Receba alertas em cada etapa do seu pedido 3D
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-[11px] text-slate-500">
                  Rastreio em tempo real com links diretos
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <p className="text-xs font-bold text-slate-900">
                  Novidades & Cupons Candy
                </p>
                <p className="text-[11px] text-slate-500">
                  Promoções de lançamentos e novos filamentos
                </p>
              </div>
              <Switch
      ...
      <Dialog
        ...
        title="Trocar Senha"
        description="Sua nova senha precisa ter pelo menos 8 caracteres."
      >
        <form
        ...
        >
          ...
          <div className="pt-2 flex justify-end gap-2">
            ...
            <Button type="submit" variant="dengo">
              Atualizar Senha
            </Button>
          </div>
        </form>
