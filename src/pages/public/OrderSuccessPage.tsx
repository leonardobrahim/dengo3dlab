    ...
    return (
      <StoreLayout>
        <div className="flex flex-col h-[60vh] items-center justify-center space-y-4">
          ...
          <Button variant="dengo" onClick={() => navigate("/")}>
            Voltar à Loja
          </Button>
        </div>
      </StoreLayout>
      ...
      <div className="max-w-3xl mx-auto py-12 text-center space-y-8 px-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed max-w-lg mx-auto">
            O seu pedido <strong>#{order.orderNumber}</strong> foi processado.
            Você receberá atualizações por e-mail sobre a produção 3D e o envio.
          </p>
        </div>
