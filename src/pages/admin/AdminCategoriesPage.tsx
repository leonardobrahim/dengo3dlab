    ...
    <AdminLayout>
      <div className="space-y-6 text-left pb-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
          <div className="space-y-1">
            <h1 className="text-2xl font-black text-foreground">Categorias & Coleções</h1>
          ...
          {categories.map((cat) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <Badge variant="sky">{cat.productCount} Itens</Badge>
              </div>
              ...
              <div className="pt-3 flex items-center justify-between border-t border-border text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => handleDelete(cat.id)} className="p-1.5 bg-muted rounded-lg text-muted-foreground hover:text-rose-600 hover:bg-rose-50 transition-colors">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold">Categoria Pai (Opcional)</label>
          ...
          <div className="pt-4 flex justify-end gap-2 border-t border-border mt-4">
            ...
            <Button variant="dengo" onClick={handleSave}>Salvar Categoria</Button>
          </div>
        </div>
      </Dialog>
    </AdminLayout>
