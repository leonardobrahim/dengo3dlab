        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Gerencie o acesso da equipe ao painel
            </p>
          </div>
          <Button
            variant="dengo"
                ...
                >
                  ...
                  <td className="p-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        onClick={() => setIsModalOpen(true)}
                        className="p-1.5 bg-muted rounded-lg text-muted-foreground hover:text-sky-600 hover:bg-sky-50 transition-colors"
                      >
          ...
          <div className="space-y-1">
            ...
            <select className="w-full bg-background border border-border rounded-xl p-2.5 text-sm">
              ...
              <option value="superadmin">
                Super Admin (Configurações críticas)
              </option>
            </select>
          </div>
