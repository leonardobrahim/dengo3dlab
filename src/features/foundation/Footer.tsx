...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-pink-200/60 dark:border-pink-900/40 bg-linear-to-b from-card/60 to-pink-50/40 dark:to-card/90 text-muted-foreground text-xs py-12 mt-16">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 text-center md:text-left">
          ...
          <div className="space-y-3 max-w-sm">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              O estúdio mais fofo do Brasil em manufatura aditiva! Colecionáveis
              articulados, filamentos candy colors (rosa bebê e azul céu),
              cortadores e projetos sob medida.
            </p>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs text-muted-foreground">
                <li className="hover:text-pink-500 cursor-pointer">
                  Lontrinhas & Articulados
                </li>
                <li className="hover:text-pink-500 cursor-pointer">
                  Filamentos Rosa & Azul Bebê
                </li>
                <li className="hover:text-pink-500 cursor-pointer">
                  Cortadores de Biscoito
                </li>
                <li className="hover:text-pink-500 cursor-pointer">
                  Vasinhos Bob & Decoração
                </li>
              </ul>
            </div>
